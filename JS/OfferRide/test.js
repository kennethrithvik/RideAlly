$(document).ready(function () {
    ...
    $("#btnSubmitVehicle").click(function () {
        ...
        {
            var surl = "http://192.168.3.185:8025/Rideally.service/api/Employee/AddVehicleDetail";
            var vehicle = {
    ...
    $("#btnUpdate").click(function () {
        ...
        else
        {
            ...
            var surl = "http://192.168.3.185:8025/Rideally.service/api/Schedule/InsertSchedule";
            $.ajax({
                url: surl,
                type: "POST",
                datatype: 'json',
