...
$(function () {
    ...
    var eurl = "http://192.168.3.185:8025/Rideally.service/api/Schedule/GetScheduleByEmployeeID?id=" + employeeid;
    $schedules = [];
    ...
    $("#btnUpdate").on('click', function () {
        ...
        if (flag == true) {
            ...
            $.ajax({
                url: "http://192.168.3.185:8025/Rideally.service/API/Schedule",
                type: 'POST',
                data: scheduleobject,
                dataType: 'JSON',
